...
DROP POLICY IF EXISTS "Permitir leitura de usuários" ON usuarios_7af4432d;
DROP POLICY IF EXISTS "Permitir criação de usuários" ON usuarios_7af4432d;
DROP POLICY IF EXISTS "Permitir atualização de usuários" ON usuarios_7af4432d;
...
CREATE POLICY "Permitir leitura de usuários" ON usuarios_7af4432d
  FOR SELECT USING (true);

CREATE POLICY "Permitir criação de usuários" ON usuarios_7af4432d
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Permitir atualização de usuários" ON usuarios_7af4432d
